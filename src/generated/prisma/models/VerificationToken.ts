...
> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<VerificationTokenGroupByOutputType, T['by']> & {
      [
        P in keyof T & keyof VerificationTokenGroupByOutputType
      ]: P extends '_count'
        ? T[P] extends boolean
          ? number
...
export type VerificationTokenWhereInput = {
  AND?:
    Prisma.VerificationTokenWhereInput | Prisma.VerificationTokenWhereInput[]
...
export type VerificationTokenScalarWhereWithAggregatesInput = {
  ...
  expires?:
    Prisma.DateTimeWithAggregatesFilter<'VerificationToken'> | Date | string
}
